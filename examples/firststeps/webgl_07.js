...
`;
    ...
    initBuffers07(gl, shaderProgram);

    initTexture07(gl, shaderProgram);

}

function initBuffers07(gl, shaderProgram) {
...
function initTexture07(gl, shaderProgram) {
    ...
    image.onload = function () {
        loadTexture07(gl, texture, u_Sampler, image);
    };
...
function loadTexture07(gl, texture, u_Sampler, image) {
